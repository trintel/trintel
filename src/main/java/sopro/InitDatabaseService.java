...
public class InitDatabaseService {
    ...
    public void init() {
        ...
        if (userRepository.count() == 0 && companyRepository.count() == 0) {
            ...
            ActionType abortBuyer = new ActionType("Abort", "Option to abort transaction for buyer.", InitiatorType.BUYER);
            ActionType abortSeller = new ActionType("Abort", "Option to abort transaction for seller.", InitiatorType.SELLER);
            ...
            abortBuyer.setStandartAction(true);
            abortSeller.setStandartAction(true);
            ...
            actionTypeRepository.save(abortBuyer);
            actionTypeRepository.save(abortSeller);
